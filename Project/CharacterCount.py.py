#message = "It was a dark and stormy night, and the skipper said to the mate : Mate, tell me a story.And this is the story he told:"
...
for character in message.upper() :  #counts both lower and upper character as 1
    count.setdefault(character,0) #it will make value 0 for all characters if they are not there
...
#we imported prettyprint which maskes it wasier to sort the output
